...
class Ui_Dialog(object):
    ...
    def __init__(self, a):
        ...
        self.a = a
    #creating the graphical user interface and adding components
    def setupUi(self, Dialog):

        Dialog.setObjectName("Dialog")
        #menu for cryptography
   ...
   #calling the a.py if clicked for Cryptography
    def clicka(self):

        self.mainwin=QMainWindow()  
        self.ui=b.Ui_Dialog(self.mainwin) 
        self.ui.setupUi(self.mainwin)  
        self.mainwin.setWindowTitle("       Cryptography")
        self.mainwin.setFixedSize(666, 421)
        self.mainwin.move(300,100)
        self.mainwin.show() 
        self.a.hide()
        
    #calling the b.py if clicked for Steganography
    def clickb(self):

        self.mainwin=QMainWindow()  
        self.ui=a.Ui_Dialog(self.mainwin) 
        self.ui.setupUi(self.mainwin)  
        self.mainwin.setWindowTitle("Stegnography")
        self.mainwin.setFixedSize(666, 421)
        self.mainwin.move(300,100)
        self.mainwin.show() 
        self.a.hide()
...
def init():
    ...
    ui = Ui_Dialog(Dialog)
    ui.setupUi(Dialog)
    Dialog.setWindowTitle("    Cryptography And Stegnography")
