...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
     ...
     #decrypting the cipher data to stego file 

    def rund(self):
        #decrypting the cipher data
    ...
    #encrypting the stego file into a cipher data
    def en(self):
     ...
     #uploading a cipher data file  from desktop
    def image0(self):
    ...
    def main(self):
        ...
        self.mainwin.setWindowTitle("    Cryptography And Stegnography")
